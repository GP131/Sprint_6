class TestData:
    test_data_user1 = ['Иван', 'Иванов', 'Проспект Вернадского 93', 'Тропарёво', '+79990001111', '05.02.2025',
                       'Позвонить по приезду']

    test_data_user2 = ['Петр', 'Петров', 'Проспект Мира 22', 'Проспект Мира', '+79991112222', '05.02.2025',
                       'Позвонить за 5 минут до приезда']
